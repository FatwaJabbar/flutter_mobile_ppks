...
class PerawatanSanitasiPage extends StatefulWidget {
  ...
  @override
  State<PerawatanSanitasiPage> createState() =>
      _PerawatanSanitasiPageState();
}
...
class _PerawatanSanitasiPageState extends State<PerawatanSanitasiPage> {
  ...
  Future<void> _simpanData() async {
    if (_tanggalController.text.isEmpty || _lokasiController.text.isEmpty) {
    ...
    final dataBaru = {
      ...
      "jenisPupuk": _lokasiController.text,
      "jumlah": 0,
